class Road extends Phaser.GameObjects.Container
{
    constructor(config)
    {
        ...
        this.add(this.car);
        Align.scaleToGameW(this.car,.07);
    ...
    addObject(){
        var objs=[{key:'pcar1',speed:10,scale:25},{key:'pcar2',speed:10,scale:18},{key:'cone',speed:10,scale:18},{key:'barrier',speed:10,scale:18}];
